        ...
        return (
            <div>
                ...
                <div class="container">
                    <h2>Contact Us</h2>
                    <div class="us">
                        <h3>For inquiries, suggestions, or complaints, contact us at</h3>
                        <div class="phone">
                            <i class="fab fa-whatsapp"></i>
                            <span>15355 </span>
                        </div>
                        <p>Or fill in this form and we will get back to you.</p>
                    </div>
                    <form action="">
                        ...
                        <label for="Tazkarti-ID">Tazkarti ID*</label>
                        <input
                            type="text"
                            name="Tazkarti ID"
                            id="Tazkarti-ID"
                            placeholder="Tazkarti ID"
                        />
